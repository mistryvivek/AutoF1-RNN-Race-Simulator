"""
Script used to train the AutoF1GRU model for F1 telemetry data prediction.
...
class AutoF1GRU(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.compound_prediction = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(p=DROPOUT),
            nn.Linear(hidden_size // 2, NUM_COMPOUNDS)
        )
...
train(AutoF1GRU(INPUT_SIZE, HIDDEN_SIZE), DATASET, "test_without_scheduler_gru", is_lstm=False)